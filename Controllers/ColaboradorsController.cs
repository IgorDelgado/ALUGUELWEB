...
namespace Aluguel.Controllers
{
    public class ColaboradorsController : Controller
    {
        ...
        public ColaboradorsController(Contexto context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Nome,Funcao")] Colaborador colaborador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Nome,Funcao")] Colaborador colaborador)
        {
